...
npr_wins = end_npr |>
  ...
  distinct(home_team, away_team, home_score, away_score, win_team, lose_team, winner_npr) |>
  filter(winner_npr == min(winner_npr) | winner_npr == max(winner_npr)) |>
  mutate(x = paste0(win_team, " def. ", lose_team, " (+", winner_npr, ")")) |>
...
- Best Win: `r npr_wins[1]`
- Worst Win: `r npr_wins[2]`
